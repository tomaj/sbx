...
import { ExternalLink, Folder, RefreshCcw, Trash2, X, Wand2, ImageIcon } from 'lucide-react';
...
export function AssetDetailModal({
  ...
  // Fetch fresh asset data on open
  ...
  // References: only fetch when tab is active
    ...
    <>
        ...
        >
          ...
          <div className="w-96 shrink-0 flex flex-col">
            ...
            <div className="flex items-center justify-end gap-1 px-4 py-3 border-b border-gray-200 dark:border-gray-700">
              ...
              />
              <CopyButton text={assetPublicUrl(asset.filename)} />
              <button
              ...
              {tab === 'overview' ? (
                <div className="px-5 py-4 flex flex-col gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 select-all">
                      {asset.id}
                    </p>
                  </div>
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-0.5">
                        Private assets are not available to the public and can only be accessed via
                        an access token.
                      </p>
                    </div>
                    <button
                    ...
                    <>
                      ...
                      {referenceStories.length === 0 ? (
                        <p className="text-sm text-gray-400 italic">
                          No stories reference this asset.
                        </p>
                      ) : (
      ...
      {showEditorTodo && (
        <div
          ...
          onClick={() => setShowEditorTodo(false)}
        >
          <div
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              The image editor is not available yet. This feature is planned for a future release.
            </p>
      ...
      {showMoveTodo && (
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Moving assets to folders is not available yet. This feature is coming soon.
            </p>
            <div className="flex justify-end">
              <button
                onClick={() => setShowMoveTodo(false)}
