export const ACTIVITY_TYPES = [
  { value: 'story.update', label: 'Updated · Story' },
  { value: 'story.publish', label: 'Published · Story' },
  { value: 'story.unpublish', label: 'Unpublished · Story' },
  { value: 'story.delete', label: 'Deleted · Story' },
  { value: 'asset.create', label: 'Created · Asset' },
  { value: 'asset.update', label: 'Updated · Asset' },
  { value: 'asset_folder.create', label: 'Created · Asset Folder' },
  { value: 'scheduled_content.create', label: 'Created · Scheduled Content' },
  { value: 'scheduled_content.update', label: 'Updated · Scheduled Content' },
  { value: 'release.create', label: 'Created · Release' },
  { value: 'release.update', label: 'Updated · Release' },
  { value: 'branch.deploy', label: 'Deployed · Branch' },
  { value: 'ai_log.update', label: 'Updated · AI Log' },
]
