    ...
    case 'link':
      return (
        <svg width={s} height={s} viewBox="0 0 28 28" fill="none">
          ...
          <path
            d="M12 16a3 3 0 0 1 0-4l2-2a3 3 0 0 1 4 4l-1 1"
            stroke="#a16207"
            strokeWidth="1.5"
            strokeLinecap="round"
            fill="none"
          />
          <path
            d="M16 12a3 3 0 0 1 0 4l-2 2a3 3 0 0 1-4-4l1-1"
            stroke="#a16207"
            strokeWidth="1.5"
            strokeLinecap="round"
            fill="none"
    ...
    case 'section':
      return (
        <svg width={s} height={s} viewBox="0 0 28 28" fill="none">
          <rect width="28" height="28" rx="6" fill="#fee2e2" />
          <path
            d="M7 12a2 2 0 0 1 2-2h2l2-2h4a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2v-8z"
            stroke="#b91c1c"
            strokeWidth="1.5"
            fill="none"
          />
    ...
    case 'custom':
      return (
        <svg width={s} height={s} viewBox="0 0 28 28" fill="none">
          ...
          <path
            d="M10 14c0-1.1.9-2 2-2h.5c.8 0 1.5-.7 1.5-1.5S13.3 9 12.5 9H12M18 14c0 1.1-.9 2-2 2h-.5c-.8 0-1.5.7-1.5 1.5s.7 1.5 1.5 1.5H16"
            stroke="#0f766e"
            strokeWidth="1.5"
            strokeLinecap="round"
            fill="none"
