...
export async function GET(
  ...
  return proxyResponse(await apiFetch(`/v1/spaces/${spaceId}/stories/${storyId}/discussions?${qs}`))
}
...
export async function POST(
  ...
  return proxyResponse(await apiFetch(`/v1/spaces/${spaceId}/stories/${storyId}/discussions`, {
    method: 'POST',
