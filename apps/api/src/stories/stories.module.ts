...
@Module({
  ...
  controllers: [StoriesCdnController, LinksCdnController, StoriesController],
  providers: [StoriesService, StoriesCdnService, LinksCdnService, TokenGuard, SessionOrTokenGuard],
})
